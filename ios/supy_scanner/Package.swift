...
// the repo-root native/ tree, which is shared with Android and dart:ffi):
//
//   Sources/
//     objc/                         -> clang target root (real dir)
//       bridge  -> ../../../Classes/nativecore   (Obj-C++ bridge .mm/.h)
//       native  -> ../../../../native            (shared C++ core)
...
let package = Package(
    ...
    targets: [
        ...
        // Classes/** + ../native compile and header search paths. zxing-cpp /
